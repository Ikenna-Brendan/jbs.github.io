  ...
  const features = [
    {
      ...
      description: 'Fully certified and compliant with all Nigerian regulatory standards and international best practices.',
    },
    {
      icon: Users,
      title: 'Expert Team',
      description: 'Professional team of environmental consultants, engineers, and specialists with extensive experience.',
    },
    {
      icon: Award,
      title: 'Quality Assurance',
      description: 'Committed to delivering high-quality services that exceed client expectations and industry standards.',
    },
    {
      icon: Target,
      title: 'Sustainable Solutions',
      description: 'Focus on environmentally sustainable and economically viable solutions for long-term success.',
    },
  ];
            ...
            <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
              <div className="relative mx-auto w-full rounded-lg shadow-2xl lg:max-w-md">
                <div className="relative block w-full bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg overflow-hidden">
                  <img
                    className="w-full h-64 sm:h-72 lg:h-80 object-cover opacity-90 mix-blend-overlay"
